...
<style>
    ...
    * {
    ...
    color: white;
    /* line-height: 100px; 
    margin-right: 20px;margin-top: 20%;
} */
...
.card-wrapper {
    width: 400px;
    height: 400px;
    background-image: url('./img/specialcollection-1.jpg');
    background-size: cover;
    border-radius: 10px;
}

.card-wrapper .card-top p {
    color: white;
    font-size: 30px;
    font-family: roboto;
}
...
<div class="container">
    ...
    ?>
        ...
        <h1><?php echo $productImageFront ?></h1>
        <h1><?php echo $productImageBack ?></h1>
    ...
    <div class="xzoom-container">
        <div class="zoom">
            <img src="https://rukminim2.flixcart.com/image/612/612/xif0q/t-shirt/8/c/5/xxl-mens-hiltop-lycra-t-shirt-sti-original-imagxggngj2ydqpp.jpeg?q=70" alt="" class="xzoom">

        </div>
        <div class="xzoom-thumb">
            <a href="https://rukminim2.flixcart.com/image/612/612/xif0q/t-shirt/a/g/6/xl-gucci-tshirt01-xl-sti-original-imagw5z6deqd5phd.jpeg?q=70">
                <img class="xzoom-gallery" src="https://rukminim2.flixcart.com/image/612/612/xif0q/t-shirt/a/g/6/xl-gucci-tshirt01-xl-sti-original-imagw5z6deqd5phd.jpeg?q=70" alt="">
            </a>
            ...
            <a href="https://rukminim2.flixcart.com/image/612/612/xif0q/t-shirt/i/v/k/l-by-pmosh-088-beyoung-original-imagyjampgr7enjd.jpeg?q=70">
                <img class="xzoom-gallery" src="https://rukminim2.flixcart.com/image/612/612/xif0q/t-shirt/i/v/k/l-by-pmosh-088-beyoung-original-imagyjampgr7enjd.jpeg?q=70" alt="">
            </a>
            <a href="https://rukminim2.flixcart.com/image/612/612/xif0q/t-shirt/p/x/u/s-ts29-vebnor-original-imagwhgc9hhw7uwh.jpeg?q=70">
                <img class="xzoom-gallery" src="https://rukminim2.flixcart.com/image/612/612/xif0q/t-shirt/p/x/u/s-ts29-vebnor-original-imagwhgc9hhw7uwh.jpeg?q=70" alt="">
            </a>
        </div>
    </div>
    <!-- zoom container end -->
